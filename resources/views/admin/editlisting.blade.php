        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('updatelisting', $listing) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH') {{-- Add this line to specify the method --}}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="salary" name="salary"
                                        ...
                                        value="{{  $listing->salary }}" placeholder="Salary Range!">
                                    @error('salary')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="vacancies_available" name="vacancies_available"
                                        ...
                                        value="{{ $listing->vacancies_available }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="email" name="email"
                                        ...
                                        value="{{ $listing->email }}" placeholder="Email!">
                                    @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="contact_no" name="contact_no"
                                        ...
                                        value="{{  $listing->contact_no }}" placeholder="Contact No!">
                                    @error('contact_no')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="facebook" name="facebook"
                                        ...
                                        value="{{ $listing->facebook }}" placeholder="Facebook!">
                                    @error('facebook')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="instagram" name="instagram"
                                        ...
                                        value="{{  $listing->instagram }}" placeholder="Instagram!">
                                    @error('instagram')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="youtube" name="youtube"
                                        ...
                                        value="{{  $listing->youtube }}" placeholder="Youtube!">
                                    @error('youtube')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <form action="{{ route('editadddesc', $listing) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
