...
@section('content')
    <div class="row">
        ...
        <div class="col-6 text-end">
            <a href="{{ route('employers') }}" class="btn btn-primary">Back to Listings</a>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        <div id="picture-section">
                            @if ($employer->picture)
                                <img src="{{ asset('template/img/employerphotos/' . $employer->picture) }}"
                                    alt="Employer Picture" class="img-fluid rounded-circle mb-2" width="200" height="200" />
                            @else
                        ...
                        <div>
                            <a href="{{ route('editemployer', $employer->id) }}" class="btn btn-primary">Edit</a>

                            <form action="{{ route('delete', $employer->id) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')
