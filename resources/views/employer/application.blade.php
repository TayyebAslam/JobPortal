    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                            ...
                            <tbody>
                                @foreach ($resumes as $singleResume)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ asset('template/img/resume/' . $singleResume->pdf) }}"
                ...
                <td>
                    <form method="post" action="{{ route('accept.resume', $singleResume->id) }}" style="display: inline;">
                        @csrf
                        <input type="hidden" name="status" value="accepted">
                        <button type="submit" class="btn btn-success">Accept</button>
                    </form>

                    <form method="post" action="{{ route('reject.resume', $singleResume->id) }}" style="display: inline;">
                        @csrf
